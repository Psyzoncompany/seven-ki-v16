...
const atlases={};
for(const [id,name,cols,rows,height] of [['piccolo','piccolo-fight-v31',5,3,116],['gokuFight','goku-fight-v32',6,5,105],['gohan','gohan-child-v26',3,2,64],['goku','goku-v8',6,5,105],['arrivalProps','arrival-props-v23',3,2,100],['saiyanBosses','saiyan-bosses-v21',6,3,125]]){
...
console.log('Runtime atlas loader: 30 Goku combat poses + 15 Piccolo combat poses + 6 Gohan poses; captive segment rendered.');
